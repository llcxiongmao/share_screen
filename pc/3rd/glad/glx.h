 ...
 *
 * Commandline:
 *    --api='glx=1.3' --extensions='GLX_ARB_create_context,GLX_EXT_swap_control' c --alias --header-only --loader
 *
 * Online:
 *    http://glad.sh/#api=glx%3D1.3&extensions=GLX_ARB_create_context%2CGLX_EXT_swap_control&generator=c&options=ALIAS%2CHEADER_ONLY%2CLOADER
 *
 */
